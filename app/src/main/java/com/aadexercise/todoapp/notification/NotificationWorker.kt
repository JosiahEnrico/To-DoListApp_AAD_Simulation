package com.aadexercise.todoapp.notification
...
import com.aadexercise.todoapp.ui.detail.DetailTaskActivity
...
class NotificationWorker(ctx: Context, params: WorkerParameters) : Worker(ctx, params) {
    ...
    override fun doWork(): Result {
        ...
        val value =
            sharedPreferences.getBoolean(applicationContext.getString(R.string.pref_key_notify),false)
        if (value) {
